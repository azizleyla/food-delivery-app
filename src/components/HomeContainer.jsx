    ...
    >
      <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
        ...
        <p className="text-base text-textColor text-center md:text-left md:w-[80%]">
          ...
          iusto deserunt recusandae ipsa minus eos sunt, dolores illo
      ...
      <div className="py-2 flex-1 flex items-center relative">
        ...
        <div className="w-full h-full absolute top-0 left-0 text-center flex items-center justify-center lg:px-32  py-4 gap-4 flex-wrap">
          {heroData &&
            heroData.map((n) => (
              <div
                key={n.id}
